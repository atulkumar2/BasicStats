...
namespace BasicStats
{
    public class Start
    {
        ...
        public void Run(String[] Args)
        {
            ...
            switch (qChoice)
            {
                case QueryType.CalculateQuartiles:
                    new Quartiles().DriveConsole();
                    break;
                case QueryType.CalculateMedian:
                    new Median().DriveConsole();
                    break;
                case QueryType.None:
            ...
            Console.WriteLine(Environment.NewLine + "Good Bye. We did as you asked. See you again." + Environment.NewLine);
        ...
        private void showMenuOptions()
        {
            ...
            Console.WriteLine(" {0}. Calculate Quartiles.", (int)QueryType.CalculateQuartiles);
            Console.WriteLine(" {0}. Calculate Median.", (int)QueryType.CalculateMedian);
            return;
        }
